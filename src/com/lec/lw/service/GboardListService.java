...
public class GboardListService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		if(schword==null) schword = "";
		GboardDao gboardDao = GboardDao.getInstance();
		ArrayList<GboardDto> gboardList = gboardDao.listGboard(schword, startRow, endRow);
		request.setAttribute("gboardList", gboardList);
		int totCnt = gboardDao.getGboardTotCnt(schword); // 글갯수
