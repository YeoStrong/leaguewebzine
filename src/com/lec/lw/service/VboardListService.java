...
public class VboardListService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		ArrayList<VboardDto> vboardList = vboardDao.listVboard(schword, startRow, endRow);
		request.setAttribute("vboardList", vboardList);
		int totCnt = vboardDao.getVboardTotCnt(schword); // 글갯수
