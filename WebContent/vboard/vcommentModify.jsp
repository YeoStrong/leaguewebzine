...
<body>
	...
	<div id="content_form">
		<form action="${conPath }/vboardCommentModify.do">
			<input type="hidden" name="vnum" value="${vcomment.vnum }">
			<input type="hidden" name="vcnum" value="${vcomment.vcnum }">
			<table class="table caption-top w-50 align-middle">
				<caption>댓글 수정</caption>
				<tr>
					<th>댓글</th>
					<td>
						<textarea rows="2" cols="20" name="vccontent">${vcomment.vccontent}</textarea>
					</td>
				</tr>
			</table>
