<%@page import="com.lec.lw.dto.MemberDto"%>
<%@page import="com.lec.lw.dao.MemberDao"%>
...
<%
	...
	if(MemberDao.EXISTENT == dao.midConfirm("abc")){
		out.println("abc는 중복된 ID");
...
<h1>5. 회원정보 수정(abc회원정보 수정)</h1>
	...
	<h1>6. 회원리스트 (4~6)</h1>
	<%--
		ArrayList<MemberDto> members = dao.getMemberlist(2, 3); 
