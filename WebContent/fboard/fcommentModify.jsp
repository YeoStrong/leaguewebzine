...
<body>
	...
	<div id="content_form">
		<form action="${conPath }/fboardCommentModify.do">
			<input type="hidden" name="fnum" value="${fcomment.fnum }">
			<input type="hidden" name="fcnum" value="${fcomment.fcnum }">
			<table class="table caption-top w-50 align-middle">
				<caption>댓글 수정</caption>
				<tr>
					<th>댓글</th>
					<td>
						<textarea rows="2" cols="20" name="fccontent" class="form-control">${fcomment.fccontent}</textarea>
					</td>
				</tr>
			</table>
